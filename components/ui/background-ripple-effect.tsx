  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        ...
        >
          <Pattern cellClassName="border-[#00FF88]/10 relative z-[100]" rippleColor="rgba(0, 255, 136, 0.2)" />
        </div>

        <Pattern className="opacity-[0.3]" cellClassName="border-white/5" rippleColor="rgba(0, 209, 255, 0.1)" />
      </div>
    </div>
  );
};
